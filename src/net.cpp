...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tracoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tracointools.com", "23.227.163.229"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tracointools.com", "testnet-seed.tracointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tracoin is probably already running."), addrBind.ToString().c_str());
        else
